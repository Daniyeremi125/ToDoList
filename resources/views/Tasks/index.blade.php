...
<html lang="en">
  <head>
    <!-- Añadir Google Fonts para Muthiara -->
    <link href="https://fonts.googleapis.com/css2?family=Muthiara&display=swap" rel="stylesheet">
    ...
    <div class="card-header border-0">
      <div class="row align-items-left">
        <div class="col text-left">
          <h3 class="mb-0 font-weight-bold text-primary" style="font-size: 2rem; font-family: 'Muthiara', sans-serif;">
            Tareas
        ...
        <div class="col text-right">
          <a href="{{ url('tareas/create') }}" class="btn btn-sm btn-primary">Agregar Tarea
      ...
      <table class="table align-items-center table-flush">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
              <a href="{{ url('tareas/' . $task->id . '/edit') }}" class="btn btn-sm btn-primary">Editar
